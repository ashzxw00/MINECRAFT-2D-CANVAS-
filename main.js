...
console.log("a tecla shift e p foram pressionadas juntas");
...
if(e.shiftKey == true && keyPressed == '77'){
    console.log("a tecla shift e m foram pressionadas juntas");
    blockImageWidth = blockImageWidth-10;
    blockImageHeight = blockImageHeight-10;
    document.getElementById("currentWidth").innerHTML = blockImageWidth;
    document.getElementById("currentHeight").innerHTML = blockImageHeight;
...
function up(){
    if(playerY >= 0 ){
        ...
        console.log("a altura da imagem=" +blockImageHeight);
...
function left(){
    if(playerX > 0 ){
        ...
        console.log("a largura da imagem="+blockImageWidth);
